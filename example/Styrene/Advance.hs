...
import "gloss-gtk" Graphics.Gloss.Geometry
import "gloss-gtk" Graphics.Gloss.Interface.Simulate
import "gloss-gtk" Graphics.Gloss.Data.Point
import "gloss-gtk" Graphics.Gloss.Data.Vector
...
advanceWorld a b c = par x x
 where x = advanceWorld' a b c
